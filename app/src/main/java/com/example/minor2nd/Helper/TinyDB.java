...
public class TinyDB {
    ...
    public ArrayList<FProducts> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FProducts> playerList =  new ArrayList<FProducts>();

        for(String jObjString : objStrings){
            FProducts player  = gson.fromJson(jObjString,  FProducts.class);
    ...
    public void putListObject(String key, ArrayList<FProducts> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FProducts player: playerList){
